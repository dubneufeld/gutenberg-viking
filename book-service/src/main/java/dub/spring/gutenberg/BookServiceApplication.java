...
public class BookServiceApplication {
  ...
  public void initIndicesAfterStartup() {
    ...
    ReactiveIndexOperations indexOps = mongoTemplate.indexOps(CategoryEntity.class);
    resolver.resolveIndexFor(CategoryEntity.class).forEach(e -> indexOps.ensureIndex(e).block());
  }
}